  ...
  methods: {
    loadSupplierList() {
      ...
      if (!_this.isNullOrEmpty(_this.enterpriseName)) {
        _this.params.params.companyName = _this.enterpriseName;
      } else if (
      ...
      _this.$store
        .dispatch("supplier/getSupplierList", _this.params)
        .then(res => {
    ...
    showDetail(id) {
      var _this = this;
      _this.$store
        .dispatch("supplier/getSupplierInfo", { id: id })
        .then(res => {
    ...
    saveSupplierInfo() {
      ...
      _this.$store
        .dispatch("supplier/insertSupplierInfo", _this.form)
        .then(res => {
          if (res.code == 200) {
            _this.$message({
              showClose: true,
